...
dataname = '人工智能4'
wb = xlrd.open_workbook("E:/MOOC/MOOC_Improvement_Based_on_Aspect-based_Sentiment_Analysis_Driven_by_Large_Language_Models/data" + dataname + ".xls")
...
book2.save("E:/MOOC/MOOC_Improvement_Based_on_Aspect-based_Sentiment_Analysis_Driven_by_Large_Language_Models/data_after_preprocessing/" + dataname + ".xls")
